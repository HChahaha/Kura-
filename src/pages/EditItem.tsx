  ...
  return (
    ...
    >
      ...
      <form className="space-y-12 px-2" onSubmit={handleSubmit}>
        {/* Photo Section */}
        <div className="relative aspect-video rounded-[24px] overflow-hidden border border-zinc-100 group shadow-lg">
          <img 
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end p-6 gap-2">
            <button 
              type="button"
              onClick={handleRefreshImage}
              className="px-4 py-2 bg-white/20 backdrop-blur-md border border-white/30 rounded-full text-[10px] font-bold uppercase tracking-widest text-white flex items-center gap-2 hover:bg-white/40 transition-all"
            >
