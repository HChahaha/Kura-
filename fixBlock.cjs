...
const strToReplace = `                              <span className="font-bold">\$\{(lowestPast.price)?.toString().replace('
                  </div>`;

// Wait, the file is currently broken. I need to fix lines 1189 to 1206.
// Let's just restore the file from git? No git.
// Let's generate a full replacement from lines 1171 to 1218.
