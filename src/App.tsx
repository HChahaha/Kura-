...
export default function App() {
 ...
 const handleConsumeItem = async (consumedId: string, addToBuyList: boolean = false) => {
 if (!user) return;
 ...
 if (addToBuyList) {
 // Trigger To-Buy List Automation intentionally: append to active "To-Buy List"
 ...
 triggerNotification(`${itemToConsume.name} added back to To-Buy list.`);
 }
